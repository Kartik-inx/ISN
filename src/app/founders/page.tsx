    ...
    <>
      ...
      <section className="relative pt-40 pb-20 overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            src="/images/hero_founders.png"
            alt="The Founders - Three figures standing resolutely"
            fill
            priority
        ...
        <div className="relative max-w-5xl mx-auto px-6 text-center">
          <ScrollReveal>
            ...
            <p className="text-lg text-slate-light max-w-2xl mx-auto">
              Founded by those who lived it — officers and specialists who
              experienced the failures of the system and decided to act.
            </p>
          </ScrollReveal>
        </div>
      </section>
